...
#define PVD_CONFIG_SREF_S          4
#define PVD_CONFIG_SREF_M          (1 << PVD_CONFIG_SREF_S)
#define PVD_CONFIG_UNDER_THRESH_S  5
#define PVD_CONFIG_UNDER_THRESH_M  (0b1111 << PVD_CONFIG_UNDER_THRESH_S)
#define PVD_CONFIG_OVER_THRESH_S   9
#define PVD_CONFIG_OVER_THRESH_M   (0b1111 << PVD_CONFIG_OVER_THRESH_S)
#define PVD_CONFIG_EN_VREFCLB_S    13
